...
const Artikel = () => {
    ...
    useEffect(() => {
        ...
        const fetchArtikels = async () => {
            try {
                const response = await getArtikel(search, currentPages);
    ...
    const filteredArtikels = useMemo(
        () =>
            (Array.isArray(artikels) ? artikels : Object.values(artikels ?? {})).map(
                (artikel, index) => ({
                    ...artikel,
                    index,
                })
