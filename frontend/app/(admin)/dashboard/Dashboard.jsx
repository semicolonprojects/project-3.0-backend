          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start rtl:justify-end">
              ...
              <Link href="/dashboard" className="flex ms-2 md:me-24">
                <Image className="w-16 h-10 mr-2.5" src={logo} />
      ...
      >
        <div className="h-full px-3 pb-4 overflow-y-auto bg-white ">
          <ul className="space-y-2 font-medium">
            ...
            <li className="">
              <button
                className="flex items-center p-2 w-full text-gray-900 rounded-lg group hover:bg-gray-100 transition duration-75 "
                onClick={toggleMulti}
              >
                <svg
                  className="flex-shrink-0 w-5 h-5 text-[#3f8ac7] transition duration-75  group-hover:text-[#4EAEFD] "
                ...
                <span className="flex ms-3 whitespace-nowrap">Services</span>
              </button>
              {showMulti && (
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Resi</span>
              </Link>
            </li>
            <li>
              <Link
