                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center justify-start rtl:justify-end">
                            <button
                                ...
                                type="button"
                                class="inline-flex items-center p-2 text-sm text-[#4EAEFD] rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                            >
                ...
                <div class="h-full px-3 pb-4 overflow-y-auto bg-white ">
                    <ul class="space-y-2 font-medium">
                        <li>
                            ...
                            >
                                <svg
                                    class="flex-shrink-0 w-5 h-5 text-[#3f8ac7] transition duration-75  group-hover:text-[#4EAEFD] "
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
