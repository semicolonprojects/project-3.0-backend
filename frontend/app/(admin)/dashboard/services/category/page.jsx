  ...
  return (
    <>
      <table className="max-w-[974px] w-full text-sm text-left text-gray-500">
        ...
        <button className="bg-green-500 hover:bg-green-400 inline-flex items-center  text-white p-2.5 rounded-lg w-full"  onClick={() => handleEdit()} >
        ...
        <tbody>
            ...
            <tr className="border-b hover:bg-white hover:bg-opacity-70">
                ...
                <td className="px-5 py-3">
                  ...
                  <button className='grid grid-flow-row text-gray-600' onClick={() => handelDeleteTask(category.id)}>
