...
const ServicesProducts = () => {
    ...
    return (
        <div className="relative pt-12 pb-5 mx-3 phone:mx-4 phone2:mx-8 laptop:mx-44 laptop:ml-32 laptop-lg:mx-28 laptop-lg:w-[85.9%] desktop-sm:mx-32 desktop-lg:mx-48 w-full">
