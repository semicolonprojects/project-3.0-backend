...
const DetailMobile = ({
  ...
  return (
    <div className=" relative mx-5 pt-28">
      ...
      <div>
        <div className="grid grid-flow-row">
          ...
          <p className="break-all tracking-tighter text-sm">{product.description}</p>
          </div>
        </div>
      ...
      <div className="w-full pb-10">
        <h2 className="font-bold text-2xl tracking-tighter flex py-7 pb-2">Produk Kami Lainnya </h2>
        {randomProductsLoading ? (
          <Spinner />
        ) : (
          <div className="grid grid-cols-2 gap-5">
            {slicedRandomProducts.map((random) => (
              <Link href={random.slug} className="group" key={random.slug}>
