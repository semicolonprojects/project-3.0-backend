...
const DetailMobile = ({
  ...
  return (
    <div className="grid grid-flow-row justify-center items-center pt-36 gap-5">
      ...
      <div className="grid grid-flow-row max-w-72 border-gray-200 rounded-lg shadow">
        <Image
        ...
        <div className="p-4 grid grid-flow-row gap-5">
          ...
          <p className="text-gray-900 font-bold text-end">
            Rp. {product.priceIDR}
          </p>
      ...
      <div className="flex justify-center items-center flex-col gap-5">
        <h2 className="font-bold text-2xl">Produk Kami Lainnya </h2>
        {randomProductsLoading ? (
          <Spinner />
        ) : (
