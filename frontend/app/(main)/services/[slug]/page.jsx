    ...
    const ComponentForOption1 = () => {
      return (
          <div className="max-w-md text-wrap">
              <p className="text-xl font-bold pb-5">{formatRupiah(service.price)}</p>
  ...
  const ComponentForOption3 = () => {
      return (
          <div className="max-w-md text-wrap ">
              ...
              menggunakan bahan yang premium sehingga sangat aman untuk Sepatu
              luxury anda. Kemudian dilakukan finishing dengan cairan water
              repellent yang membuat Sepatu anda tahan dari noda cair. (2-3hari)
          </div>
      );
  };
