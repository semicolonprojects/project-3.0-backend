    ...
    <>
      ...
      <div className="hidden tablet:block relative mx-14 py-10">
        <div className="grid grid-cols-2">
          ...
          <div className="relative mx-1">
            ...
            <div className="flex">
              <h1 className="text-4xl font-bold">Reglue Services</h1>
            </div>
            <div className="my-2">
              <div className="grid grid-flow-row">
                <div className="">
                  <div className="max-w-md text-wrap">
                    ...
                    Membersihkan seluruh bagian Sepatu, tas, dan topi mulai dari
                    outsole (bagian terluar), midsole, upper dan insole (bagian
                    terdalam) (2-3hari)
                  </div>
                </div>
              </div>
            ...
            <div className="relative pt-10 gap-2">
      ...
      <div className="block tablet:hidden relative mx-14 py-10">
        <div className="grid grid-cols-1">
          ...
          <div className="relative mx-1 py-5">
            <div className="flex">
