...
const Partnership = () => {
  return (
    <div className="py-5 px-9 tablet:px-8 laptop:px-16 desktop:px-32 flex flex-col h-auto md:h-96 w-full">
      <p className="text-[#FFB62B] font-bold text-[22px] tablet:text-5xl">
